<?php
                ...
                "images": [
                    {
                        ...
                        "cod": null,
                        "sku": null,
                        "url": "http://apipandora.wiperagency.com//storage/images/C2020509080838g.jpg",
                        "height": "190",
                        "width": "236",
     ...
     * HTTP/1.1 200 OK
        {
            ...
            "response": {
                        ...
                        "images": [
                            {
                                ...
                                "cod": null,
                                "sku": null,
                                "url": "http://apipandora.wiperagency.com//storage/images/B2020c09080838m.jpg",
                                "height": "190",
                                "width": "236",
                                "created_at": "2020-09-08T20:38:18.000000Z",
                                "updated_at": "2020-09-08T20:38:18.000000Z"
                        ...
                        "images": [
                            {
                                ...
                                "cod": null,
                                "sku": null,
                                "url": "http://apipandora.wiperagency.com//storage/images/72020v09080838k.jpg",
                                "height": "190",
                                "width": "236",
                                "created_at": "2020-09-08T20:38:18.000000Z",
                                "updated_at": "2020-09-08T20:38:18.000000Z"
                ...
                "first_page_url": "http://apipandora.wiperagency.com/api/v1/admin/products/list?page=1",
                "from": 1,
                "last_page": 293,
                "last_page_url": "http://apipandora.wiperagency.com/api/v1/admin/products/list?page=293",
                "next_page_url": "http://apipandora.wiperagency.com/api/v1/admin/products/list?page=2",
                "path": "http://apipandora.wiperagency.com/api/v1/admin/products/list",
                "per_page": 10,
                "prev_page_url": null,
                "to": 10,
                "total": 2928
    ...
    */
     ...
     *    {
     *         "http://apipandora.wiperagency.com/api/v1/admin/products/VQG1vAhg4C8M7o4UCBQ1h3C7LIyTFn"
     *    }
     *
     * @apiUse ProductParams
     *
    ...
    */
     ...
     * @apiHeaderExample {json} Url-Example:
     *    {
     *         "http://apipandora.wiperagency.com/api/v1/admin/products/VQG1vAhg4C8M7o4UCBQ1h3C7LIyTFn/trash"
     *    }
     *
    ...
    */
     ...
     * @apiHeaderExample {json} Url-Example:
     *    {
     *         "http://apipandora.wiperagency.com/api/v1/admin/products/VQG1vAhg4C8M7o4UCBQ1h3C7LIyTFn/restore"
     *    }
     *
     * @apiParam {String} sku Código único do produto. Máximo 30 caracteres.
     *
    ...
    */
     ...
     * @apiHeaderExample {json} Url-Example:
     *    {
     *         "http://apipandora.wiperagency.com/api/v1/admin/products/VQG1vAhg4C8M7o4UCBQ1h3C7LIyTFn/images"
     *    }
     *
     * @apiParam {String} sku Código único do produto. Máximo 30 caracteres.
     ...
     * @apiHeaderExample {json} Url-Example:
     *    {
     *         "http://apipandora.wiperagency.com/api/v1/admin/products/VQG1vAhg4C8M7o4UCBQ1h3C7LIyTFn/images/2020Dzx9h0718uhSR5082405Imk6VK"
     *    }
     *
     * @apiParam {String} sku Código único do produto. Máximo 30 caracteres.
