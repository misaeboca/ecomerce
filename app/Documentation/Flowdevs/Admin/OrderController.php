<?php
     ...
     * @apiGroup Orders
     * @apiName Detail
     * @apiDescription Retorna la información completa de una orden asociada al <code>id_order</code>.
     * @apiUse HeaderExample
     *
     * @apiParam {String} id_order Código único de orden. Máximo 30 caracteres.
     *
    ...
    */
    ...
    /**
     * @api {put} /admin/orders/{id_order}/update Update
     * @apiGroup Orders
     * @apiName Update
     * @apiDescription Permite actualizar los datos de un
     * @apiUse HeaderExample
     *
     * @apiParam {String} [usc] <code>Id</code> del <code>Store</code>.
     * @apiParam {String} [id_order] <code>Id</code> of <code>Order</code>.
     *
     *
     * @apiSuccessExample Success-Response:
     *   HTTP/1.1 200 OK
     ...
     * @apiError no_update El Order no se pudo actualizar, contacte con el administrador.
     *
    ...
    */
    ...
    /**
     * @api {put} /admin/orders/{id_order}/trash Trash
     * @apiGroup Orders
     * @apiName Trash
     * @apiDescription Permite enviar un produto a la papelera.
     * @apiUse HeaderExample
     *
     * @apiParam {String} [usc] <code>Id</code> del <code>Order</code>.
     * @apiParam {String} [nombre] Nombre de la <code>Order</code>.
     *
     *
     * @apiSuccessExample Success-Response:
     *   HTTP/1.1 200 OK
    ...
    */
    ...
    /**
     * @api {put} /admin/orders/{id_order}/restore Restore
     * @apiGroup Orders
     * @apiName Restore
     * @apiDescription Permite restaurar un ordero enviado a la papelera.
     * @apiUse HeaderExample
     *
     * @apiParam {String} [usc] <code>Id</code> del <code>Order</code>.
     * @apiParam {String} [nombre] Nombre de la <code>Order</code>.
     ...
     *
     * @apiError require El campo es obligatorio.
     * @apiError no_restore El Order no se pudo actualizar, contacte con el administrador.
     *
     * @apiErrorExample Error-Response:
     *     HTTP/1.1 404 Not Found
     *     {
