...
class MainPayment implements \JsonSerializable
{
    ...
    public function __construct($data = null)
    {
        ...
        if (isset($data['RecurrentPayment'])) {
            $this->recurrentPayment = new MainRecurrentPayment($data['RecurrentPayment']);
        }

        if (isset($data['CreditCard'])) {
            $this->creditCard = new MainCreditCard($data['CreditCard']);
        }

        if (isset($data['DebitCard'])) {
            $this->debitCard = new MainCreditCard($data['DebitCard']);
        }
    ...
    public function populate(\stdClass $data)
    {
        ...
        $this->setInstallments($data->installments ? $data->installments: 1);

        if (isset($data->RecurrentPayment)) {
            $this->recurrentPayment = new MainRecurrentPayment(false);
            $this->recurrentPayment->populate($data->RecurrentPayment);
        }

        if (isset($data->CreditCard)) {
            $this->creditCard = new MainCreditCard();
            $this->creditCard->populate($data->CreditCard);
        }

        if (isset($data->DebitCard)) {
            $this->debitCard = new MainCreditCard();
    ...
    {
        $recurrentPayment = new MainRecurrentPayment($authorizeNow);
    ...
    public function setCreditCard(MainCreditCard $creditCard)
    {
    ...
    public function setItbis($itbis)
    {
        $this->itbis = $itbis;
        return $this;
    }
